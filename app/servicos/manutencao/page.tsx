...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/servicos/manutencao" },
  openGraph: {
    title: "Criação de Sites Profissionais | Estúdio Adler",
    description:
      "Sites rápidos, responsivos e otimizados para SEO. Tenha uma presença digital que representa de verdade a sua marca.",
    url: "https://estudioadler.com.br/servicos/manutencao",
  },
};
