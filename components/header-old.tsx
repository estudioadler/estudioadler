...
export default function Header() {
  ...
  return (
    <>
      <header
        className={[
          "fixed top-0 right-0 left-0 flex items-center justify-between px-4 py-2 md:top-0 md:right-0 md:left-0 md:px-8 md:py-4",
                  ...
                  return (
                    ...
                    >
                      <LinkHoverCard label="Serviços" icon="arrow-right">
                        {link.label}
                        <ArrowRightIcon weight="thin" className="size-10 opacity-50 group-hover:opacity-100" />
                      </LinkHoverCard>
                    </button>
                  )
                }
                ...
                return (
                  ...
                  >
                    ...
                    >
                      {link.label}
                      {link.external && (
                        <ArrowUpRightIcon weight="thin" className="size-10 opacity-50 group-hover:opacity-100" />
                      )}
                    </LinkHoverCard>
                  </CustomLink>
                )
